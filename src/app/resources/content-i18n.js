...
const createI18nContent = (t) => {
    const person = {
        ...
        location:  'Europe/Croatia',        // Expecting the IANA time zone identifier, e.g., 'Europe/Vienna'
        languages:c  // optional: Leave the array empty if you don't want to display languages
    }
